...
const PlayControl: React.FC = () => {
  ...
  return (
    <button
      className='w-10 md:w-12 h-10 md:h-12 text-[color:var(--white)] hover:text-[color:var(--primary-light)] transition border border-current rounded-full flex justify-center items-center'
